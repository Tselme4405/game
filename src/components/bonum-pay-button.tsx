          ...
          {isTestMode && (
            <div className="w-full rounded-2xl border border-amber-300 bg-amber-50 p-4 text-left">
              ...
              <p className="mt-2 text-sm text-amber-900">
                Энэ QR нь sandbox invoice тул банкны live app, QR scanner, эсвэл deeplink-р төлөхөд
                хүчингүй гэж гарна. Жинхэнэ төлбөр ажиллуулахын тулд production credential хэрэгтэй.
              </p>
            </div>
          )}
              ...
              <div className="grid grid-cols-3 gap-2">
                {actionableLinks.map((item) => (
                  <a
                    ...
                    className="flex flex-col items-center gap-1.5 rounded-xl border border-gray-200 px-2 py-3 text-center transition hover:bg-gray-50"
                  >
                    {item.logo && (
